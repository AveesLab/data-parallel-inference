...
# ./darknet detector cpu-reclaiming-mp ./cfg/coco.data ./cfg/yolov4-tiny.cfg ./weights/yolov4-tiny.weights data/dog.jpg -num_process 3 -glayer 20 -rlayer 21 -num_exp 30
